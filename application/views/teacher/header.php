...
<head>
  ...
  <title>อาจารย์ | ระบบสนับสนุนการเรียนการสอน</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('image/14642807_1150024835065185_1164436550_n.png');?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $teacher->teacher_firstname;?> <?php echo $teacher->teacher_lastname;?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Wittawas Pantumajinda
                  <small>Infotmatics, Burapha University</small>
                </p>
              </li>
