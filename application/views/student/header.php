...
<head>
  ...
  <title>นักเรียน | ระบบสนับสนุนการเรียนการสอน</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="http://reg.buu.ac.th/registrar/getstudentimage.asp?id=<?php echo $student->student_id;?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $student->student_firstname;?> <?php echo $student->student_lastname;?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $student->student_firstname;?> <?php echo $student->student_lastname;?>
